describe('npm package', function() {
  ...
  beforeAll(function() {
    ...
    this.packagedCore = require(path.join(this.tmpDir, 'package/lib/jasmine-core.src'));
  });
  ...
  it('has bootFiles', function() {
    expect(this.packagedCore.files.bootFiles).toEqual(['boot.src']);
    expect(this.packagedCore.files.nodeBootFiles).toEqual(['node_boot.src']);
