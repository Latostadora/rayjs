describe("ExceptionFormatter", function() {
  describe("#message", function() {
    it('formats Firefox exception messages', function() {
      ...
      expect(message).toEqual('A Classic Mistake: you got your foo in my bar in foo.src (line 1978)');
    });
  ...
  describe("#stack", function() {
    it("formats stack traces from Webkit, Firefox, node.src or IE10+", function() {
